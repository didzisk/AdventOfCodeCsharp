...
namespace Day5
{
	class Program
	{
		...
		static void Main(string[] args)
		{
			...
			Machine.Calc(0, largerExample, new int[] { 0}, OutputConsole);
			int[] largerExample1 =
			{
				3, 21, 1008, 21, 8, 20, 1005, 20, 22, 107, 8, 21, 20, 1006, 20, 31,
				1106, 0, 36, 98, 0, 0, 1002, 21, 125, 20, 4, 20, 1105, 1, 46, 104,
			...
			Machine.Calc(0, largerExample1, new int[] { 8}, OutputConsole);
			int[] largerExample2 =
			{
				3, 21, 1008, 21, 8, 20, 1005, 20, 22, 107, 8, 21, 20, 1006, 20, 31,
				1106, 0, 36, 98, 0, 0, 1002, 21, 125, 20, 4, 20, 1105, 1, 46, 104,
			...
			Machine.Calc(0, largerExample2, new int[] { 9}, OutputConsole);
			...
			Machine.Calc(0, memoryTask, new int[] { 5}, OutputConsole);
			Console.ReadLine();
		}
	}
}
